...
with tabs[3]:
    ...
    if st.checkbox('What a great app right?'):
        # Add a GIF using a URL
        gif_url = "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExY252emlnbnNiMGYxcjJ1OXJ4Y3Q4bXN2c2lvaDZjaTltNmt3NW1mZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/WkcB8MAwsHIZy/giphy.gif"  # Replace with your GIF URL
        st.image(gif_url, caption="Here's your GIF!", use_column_width=False)
